...
class EyeshadowFragment : Fragment(), ProductView {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_eyeshadow, container, false)

        var recyclerView = view.findViewById<RecyclerView>(R.id.rv_eyeshadow)
    ...
    private fun setLoading(isLoading: Boolean) {
        ...
        val recyclerView = view?.findViewById<RecyclerView>(R.id.rv_eyeshadow)
