...
class VeganFragment : Fragment(), ProductView {
    ...
    override fun onCreateView(
        ...
        var recyclerView = view.findViewById<RecyclerView>(R.id.rv_vegan)
