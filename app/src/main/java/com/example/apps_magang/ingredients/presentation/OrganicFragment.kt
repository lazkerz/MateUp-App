...
class OrganicFragment : Fragment(), ProductView {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_organic, container, false)

        var recyclerView = view.findViewById<RecyclerView>(R.id.rv_organic)
